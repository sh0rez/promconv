...
func NewClientConnectionsIdleMin() ClientConnectionsIdleMin {
	...
	return ClientConnectionsIdleMin{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "db",
		Name:      "client_connections_idle_min",
		Help:      "Deprecated, use `db.client.connection.idle.min` instead.",
	}, labels)}
}

func (m ClientConnectionsIdleMin) With(clientConnectionsPoolName AttrClientConnectionsPoolName, extra ClientConnectionsIdleMinOptional) prometheus.Gauge {
	return m.WithLabelValues(
		string(clientConnectionsPoolName),
	)
}

type ClientConnectionsIdleMinOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionsIdleMinOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
