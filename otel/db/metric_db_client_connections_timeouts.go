...
func NewClientConnectionsTimeouts() ClientConnectionsTimeouts {
	...
	return ClientConnectionsTimeouts{CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
		Namespace: "db",
		Name:      "client_connections_timeouts",
		Help:      "Deprecated, use `db.client.connection.timeouts` instead.",
	}, labels)}
}

func (m ClientConnectionsTimeouts) With(clientConnectionsPoolName AttrClientConnectionsPoolName, extra ClientConnectionsTimeoutsOptional) prometheus.Counter {
	return m.WithLabelValues(
		string(clientConnectionsPoolName),
	)
}

type ClientConnectionsTimeoutsOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionsTimeoutsOptional",
        "Instr": "Counter",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
