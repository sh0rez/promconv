...
func NewClientConnectionsIdleMax() ClientConnectionsIdleMax {
	...
	return ClientConnectionsIdleMax{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "db",
		Name:      "client_connections_idle_max",
		Help:      "Deprecated, use `db.client.connection.idle.max` instead.",
	}, labels)}
}

func (m ClientConnectionsIdleMax) With(clientConnectionsPoolName AttrClientConnectionsPoolName, extra ClientConnectionsIdleMaxOptional) prometheus.Gauge {
	return m.WithLabelValues(
		string(clientConnectionsPoolName),
	)
}

type ClientConnectionsIdleMaxOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionsIdleMaxOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
