...
func NewClientConnectionWaitTime() ClientConnectionWaitTime {
	...
	return ClientConnectionWaitTime{HistogramVec: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		Namespace: "db",
		Name:      "client_connection_wait_time",
		Help:      "The time it took to obtain an open connection from the pool",
	}, labels)}
}

func (m ClientConnectionWaitTime) With(clientConnectionPoolName AttrClientConnectionPoolName, extra ClientConnectionWaitTimeOptional) prometheus.Observer {
	return m.WithLabelValues(
		string(clientConnectionPoolName),
	)
}

type ClientConnectionWaitTimeOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionWaitTimeOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
