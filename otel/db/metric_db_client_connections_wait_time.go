...
func NewClientConnectionsWaitTime() ClientConnectionsWaitTime {
	...
	return ClientConnectionsWaitTime{HistogramVec: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		Namespace: "db",
		Name:      "client_connections_wait_time",
		Help:      "Deprecated, use `db.client.connection.wait_time` instead. Note: the unit also changed from `ms` to `s`.",
	}, labels)}
}

func (m ClientConnectionsWaitTime) With(clientConnectionsPoolName AttrClientConnectionsPoolName, extra ClientConnectionsWaitTimeOptional) prometheus.Observer {
	return m.WithLabelValues(
		string(clientConnectionsPoolName),
	)
}

type ClientConnectionsWaitTimeOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionsWaitTimeOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
