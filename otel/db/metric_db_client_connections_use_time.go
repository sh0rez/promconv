...
func NewClientConnectionsUseTime() ClientConnectionsUseTime {
	...
	return ClientConnectionsUseTime{HistogramVec: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		Namespace: "db",
		Name:      "client_connections_use_time",
		Help:      "Deprecated, use `db.client.connection.use_time` instead. Note: the unit also changed from `ms` to `s`.",
	}, labels)}
}

func (m ClientConnectionsUseTime) With(clientConnectionsPoolName AttrClientConnectionsPoolName, extra ClientConnectionsUseTimeOptional) prometheus.Observer {
	return m.WithLabelValues(
		string(clientConnectionsPoolName),
	)
}

type ClientConnectionsUseTimeOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionsUseTimeOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
