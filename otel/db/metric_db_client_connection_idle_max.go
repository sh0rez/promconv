...
func NewClientConnectionIdleMax() ClientConnectionIdleMax {
	...
	return ClientConnectionIdleMax{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "db",
		Name:      "client_connection_idle_max",
		Help:      "The maximum number of idle open connections allowed",
	}, labels)}
}

func (m ClientConnectionIdleMax) With(clientConnectionPoolName AttrClientConnectionPoolName, extra ClientConnectionIdleMaxOptional) prometheus.Gauge {
	return m.WithLabelValues(
		string(clientConnectionPoolName),
	)
}

type ClientConnectionIdleMaxOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionIdleMaxOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
