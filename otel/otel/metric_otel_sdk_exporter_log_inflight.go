...
func (m SdkExporterLogInflight) With(extra SdkExporterLogInflightOptional) prometheus.Gauge {
...
type SdkExporterLogInflightOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "SdkExporterLogInflightOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
