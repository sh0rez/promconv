...
func (m SdkProcessorLogQueueSize) With(extra SdkProcessorLogQueueSizeOptional) prometheus.Gauge {
...
type SdkProcessorLogQueueSizeOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "SdkProcessorLogQueueSizeOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
