...
func (m SdkExporterMetricDataPointExported) With(extras ...interface {
...
func (a SdkExporterMetricDataPointExportedExtra) OtelComponentName() AttrComponentName {
	return a.AttrComponentName
}
func (a SdkExporterMetricDataPointExportedExtra) OtelComponentType() AttrComponentType {
	return a.AttrComponentType
}
func (a SdkExporterMetricDataPointExportedExtra) ServerAddress() server.AttrAddress {
	return a.AttrServerAddress
}
func (a SdkExporterMetricDataPointExportedExtra) ServerPort() server.AttrPort {
