...
func NewSdkProcessorSpanProcessed() SdkProcessorSpanProcessed {
	...
	return SdkProcessorSpanProcessed{CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
		Namespace: "otel",
		Name:      "sdk_processor_span_processed",
...
func (a SdkProcessorSpanProcessed) WithErrorType(attr interface{ AttrErrorType() error.AttrType }) SdkProcessorSpanProcessed {
	a.extra.ErrorType = attr.AttrErrorType()
	return a
}
func (a SdkProcessorSpanProcessed) WithOtelComponentName(attr interface{ AttrOtelComponentName() AttrComponentName }) SdkProcessorSpanProcessed {
	a.extra.OtelComponentName = attr.AttrOtelComponentName()
	return a
}
func (a SdkProcessorSpanProcessed) WithOtelComponentType(attr interface{ AttrOtelComponentType() AttrComponentType }) SdkProcessorSpanProcessed {
