...
func (m SdkProcessorSpanProcessed) With(extras ...interface {
...
func (a SdkProcessorSpanProcessedExtra) OtelComponentName() AttrComponentName {
	return a.AttrComponentName
}
func (a SdkProcessorSpanProcessedExtra) OtelComponentType() AttrComponentType {
