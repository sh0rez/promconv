...
func NewSdkExporterMetricDataPointInflight() SdkExporterMetricDataPointInflight {
	...
	return SdkExporterMetricDataPointInflight{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "otel",
		Name:      "sdk_exporter_metric_data_point_inflight",
...
func (a SdkExporterMetricDataPointInflight) WithOtelComponentName(attr interface{ AttrOtelComponentName() AttrComponentName }) SdkExporterMetricDataPointInflight {
	a.extra.OtelComponentName = attr.AttrOtelComponentName()
	return a
}
func (a SdkExporterMetricDataPointInflight) WithOtelComponentType(attr interface{ AttrOtelComponentType() AttrComponentType }) SdkExporterMetricDataPointInflight {
	a.extra.OtelComponentType = attr.AttrOtelComponentType()
	return a
}
func (a SdkExporterMetricDataPointInflight) WithServerAddress(attr interface{ AttrServerAddress() server.AttrAddress }) SdkExporterMetricDataPointInflight {
	a.extra.ServerAddress = attr.AttrServerAddress()
	return a
}
func (a SdkExporterMetricDataPointInflight) WithServerPort(attr interface{ AttrServerPort() server.AttrPort }) SdkExporterMetricDataPointInflight {
