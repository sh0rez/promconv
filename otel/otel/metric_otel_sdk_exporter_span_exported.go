...
func (m SdkExporterSpanExported) With(extra SdkExporterSpanExportedOptional) prometheus.Counter {
...
type SdkExporterSpanExportedOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "SdkExporterSpanExportedOptional",
        "Instr": "Counter",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
