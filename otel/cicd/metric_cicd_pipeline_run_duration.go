...
func (m PipelineRunDuration) With(pipelineName AttrPipelineName, pipelineRunState AttrPipelineRunState, extra PipelineRunDurationOptional) prometheus.Observer {
	return m.WithLabelValues(
		string(pipelineName),
		string(pipelineRunState),
		string(extra.CicdPipelineResult),
		string(extra.ErrorType),
	)
}

type PipelineRunDurationOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "PipelineRunDurationOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
