...
func NewReceiveDuration() ReceiveDuration {
	...
	return ReceiveDuration{HistogramVec: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		Namespace: "messaging",
...
func (m ReceiveDuration) With(operationName AttrOperationName, extra interface {
...
func (a ReceiveDuration) WithErrorType(attr interface{ AttrErrorType() error.AttrType }) ReceiveDuration {
	a.extra.ErrorType = attr.AttrErrorType()
	return a
}
func (a ReceiveDuration) WithServerAddress(attr interface{ AttrServerAddress() server.AttrAddress }) ReceiveDuration {
	a.extra.ServerAddress = attr.AttrServerAddress()
	return a
}
func (a ReceiveDuration) WithServerPort(attr interface{ AttrServerPort() server.AttrPort }) ReceiveDuration {
...
func (a ReceiveDurationExtra) AttrErrorType() error.AttrType         { return a.ErrorType }
func (a ReceiveDurationExtra) AttrServerAddress() server.AttrAddress { return a.ServerAddress }
func (a ReceiveDurationExtra) AttrServerPort() server.AttrPort       { return a.ServerPort }
