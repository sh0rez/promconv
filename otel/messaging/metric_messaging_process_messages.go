...
func NewProcessMessages() ProcessMessages {
	...
	return ProcessMessages{CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
		Namespace: "messaging",
...
func (a ProcessMessages) WithErrorType(attr interface{ AttrErrorType() error.AttrType }) ProcessMessages {
	a.extra.ErrorType = attr.AttrErrorType()
	return a
}
func (a ProcessMessages) WithServerAddress(attr interface{ AttrServerAddress() server.AttrAddress }) ProcessMessages {
	a.extra.ServerAddress = attr.AttrServerAddress()
	return a
}
func (a ProcessMessages) WithServerPort(attr interface{ AttrServerPort() server.AttrPort }) ProcessMessages {
