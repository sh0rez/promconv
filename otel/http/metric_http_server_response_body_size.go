...
func (m ServerResponseBodySize) With(requestMethod AttrRequestMethod, scheme url.AttrScheme, extra ServerResponseBodySizeOptional) prometheus.Observer {
	return m.WithLabelValues(
		...
		string(extra.UserAgentSyntheticType),
	)
}

type ServerResponseBodySizeOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ServerResponseBodySizeOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
