...
func (m ServerRequestBodySize) With(requestMethod AttrRequestMethod, scheme url.AttrScheme, extra ServerRequestBodySizeOptional) prometheus.Observer {
...
type ServerRequestBodySizeOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ServerRequestBodySizeOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
