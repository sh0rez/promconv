...
func (m ClientResponseBodySize) With(requestMethod AttrRequestMethod, address server.AttrAddress, port server.AttrPort, extra ClientResponseBodySizeOptional) prometheus.Observer {
...
type ClientResponseBodySizeOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientResponseBodySizeOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
