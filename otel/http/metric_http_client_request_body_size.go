...
func (m ClientRequestBodySize) With(requestMethod AttrRequestMethod, address server.AttrAddress, port server.AttrPort, extra ClientRequestBodySizeOptional) prometheus.Observer {
...
type ClientRequestBodySizeOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientRequestBodySizeOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
