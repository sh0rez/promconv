...
func NewQueuedConnections() QueuedConnections {
	...
	return QueuedConnections{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "kestrel",
...
func (m QueuedConnections) With(extra interface {
...
func (a QueuedConnectionsExtra) AttrNetworkTransport() network.AttrTransport {
	return a.NetworkTransport
}
func (a QueuedConnectionsExtra) AttrNetworkType() network.AttrType     { return a.NetworkType }
func (a QueuedConnectionsExtra) AttrServerAddress() server.AttrAddress { return a.ServerAddress }
func (a QueuedConnectionsExtra) AttrServerPort() server.AttrPort       { return a.ServerPort }
