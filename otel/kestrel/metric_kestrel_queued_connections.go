...
func (m QueuedConnections) With(extra QueuedConnectionsOptional) prometheus.Gauge {
...
type QueuedConnectionsOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "QueuedConnectionsOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
