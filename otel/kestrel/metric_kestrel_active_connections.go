...
func (m ActiveConnections) With(extra ActiveConnectionsOptional) prometheus.Gauge {
...
type ActiveConnectionsOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ActiveConnectionsOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
