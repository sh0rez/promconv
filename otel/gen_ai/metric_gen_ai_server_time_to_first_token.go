...
func (m ServerTimeToFirstToken) With(operationName AttrOperationName, system AttrSystem, extra ServerTimeToFirstTokenOptional) prometheus.Observer {
...
type ServerTimeToFirstTokenOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ServerTimeToFirstTokenOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
