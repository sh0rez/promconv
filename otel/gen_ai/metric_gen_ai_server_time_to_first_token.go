...
func (m ServerTimeToFirstToken) With(operationName AttrOperationName, system AttrSystem, extras ...interface {
...
func (a ServerTimeToFirstTokenExtra) GenAiResponseModel() AttrResponseModel {
