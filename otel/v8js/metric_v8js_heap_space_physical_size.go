...
func NewHeapSpacePhysicalSize() HeapSpacePhysicalSize {
	...
	return HeapSpacePhysicalSize{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "v8js",
		Name:      "heap_space_physical_size",
		Help:      "Committed size of a heap space.",
	}, labels)}
}

func (m HeapSpacePhysicalSize) With(heapSpaceName AttrHeapSpaceName, extra HeapSpacePhysicalSizeOptional) prometheus.Gauge {
	return m.WithLabelValues(
		string(heapSpaceName),
	)
}

type HeapSpacePhysicalSizeOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "HeapSpacePhysicalSizeOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
