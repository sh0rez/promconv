...
func NewDiskOperations() DiskOperations {
	...
	return DiskOperations{CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
		Namespace: "system",
...
func (m DiskOperations) With(extra interface {
...
func (a DiskOperations) WithDiskIoDirection(attr interface{ AttrDiskIoDirection() disk.AttrIoDirection }) DiskOperations {
	a.extra.DiskIoDirection = attr.AttrDiskIoDirection()
	return a
}
func (a DiskOperations) WithSystemDevice(attr interface{ AttrSystemDevice() AttrDevice }) DiskOperations {
...
func (a DiskOperationsExtra) AttrDiskIoDirection() disk.AttrIoDirection { return a.DiskIoDirection }
func (a DiskOperationsExtra) AttrSystemDevice() AttrDevice              { return a.SystemDevice }
