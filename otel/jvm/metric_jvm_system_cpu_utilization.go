...
func (m SystemCpuUtilization) With(extra SystemCpuUtilizationOptional) prometheus.Gauge {
	return m.WithLabelValues()
}

type SystemCpuUtilizationOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "SystemCpuUtilizationOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
