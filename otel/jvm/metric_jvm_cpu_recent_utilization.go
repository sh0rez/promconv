...
type CpuRecentUtilization struct {
	*prometheus.GaugeVec
}

func NewCpuRecentUtilization() CpuRecentUtilization {
	labels := []string{}
	return CpuRecentUtilization{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "jvm",
...
func (m CpuRecentUtilization) With(extra CpuRecentUtilizationOptional) prometheus.Gauge {
	return m.WithLabelValues()
}

type CpuRecentUtilizationOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "CpuRecentUtilizationOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "cpu.recent_utilization",
        "Type": "CpuRecentUtilization",
        "attributes": [],
        "ctx": {
            "attributes": [],
