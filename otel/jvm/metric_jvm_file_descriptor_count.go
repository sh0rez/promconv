...
func (m FileDescriptorCount) With(extra FileDescriptorCountOptional) prometheus.Gauge {
	return m.WithLabelValues()
}

type FileDescriptorCountOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "FileDescriptorCountOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
