...
func NewStatefulsetDesiredPods() StatefulsetDesiredPods {
	labels := []string{}
	return StatefulsetDesiredPods{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "k8s",
		Name:      "statefulset_desired_pods",
		Help:      "Number of desired replica pods in this statefulset",
	}, labels)}
}

func (m StatefulsetDesiredPods) With(extra StatefulsetDesiredPodsOptional) prometheus.Gauge {
	return m.WithLabelValues()
}

type StatefulsetDesiredPodsOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "StatefulsetDesiredPodsOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
