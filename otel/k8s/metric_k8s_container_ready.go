...
func NewContainerReady() ContainerReady {
	return ContainerReady{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_ready",
		Help: "Indicates whether the container is currently marked as ready to accept traffic, based on its readiness probe (1 = ready, 0 = not ready)",
	})}
}

func (m ContainerReady) Register(regs ...prometheus.Registerer) ContainerReady {
	if regs == nil {
