...
func NewContainerCpuLimit() ContainerCpuLimit {
	return ContainerCpuLimit{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_cpu_limit",
		Help: "Maximum CPU resource limit set for the container",
	})}
}

func (m ContainerCpuLimit) Register(regs ...prometheus.Registerer) ContainerCpuLimit {
	if regs == nil {
