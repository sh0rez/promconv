...
func NewContainerStorageRequest() ContainerStorageRequest {
	return ContainerStorageRequest{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_storage_request",
		Help: "Storage resource requested for the container",
	})}
}

func (m ContainerStorageRequest) Register(regs ...prometheus.Registerer) ContainerStorageRequest {
	if regs == nil {
