...
func NewContainerMemoryLimit() ContainerMemoryLimit {
	return ContainerMemoryLimit{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_memory_limit",
		Help: "Maximum memory resource limit set for the container",
	})}
}

func (m ContainerMemoryLimit) Register(regs ...prometheus.Registerer) ContainerMemoryLimit {
	if regs == nil {
