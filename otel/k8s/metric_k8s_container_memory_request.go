...
func NewContainerMemoryRequest() ContainerMemoryRequest {
	return ContainerMemoryRequest{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_memory_request",
		Help: "Memory resource requested for the container",
	})}
}

func (m ContainerMemoryRequest) Register(regs ...prometheus.Registerer) ContainerMemoryRequest {
	if regs == nil {
