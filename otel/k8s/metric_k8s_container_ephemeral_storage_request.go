...
func NewContainerEphemeralStorageRequest() ContainerEphemeralStorageRequest {
	return ContainerEphemeralStorageRequest{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_ephemeral_storage_request",
		Help: "Ephemeral storage resource requested for the container",
	})}
}

func (m ContainerEphemeralStorageRequest) Register(regs ...prometheus.Registerer) ContainerEphemeralStorageRequest {
	if regs == nil {
...
State {
    ...
    ctx: {
        ...
        "Name": "container.ephemeral_storage.request",
