...
func NewPodCpuTime() PodCpuTime {
	labels := []string{}
	return PodCpuTime{CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
		Namespace: "k8s",
		Name:      "pod_cpu_time",
...
func (m PodCpuTime) With(extra PodCpuTimeOptional) prometheus.Counter {
	return m.WithLabelValues()
}

type PodCpuTimeOptional struct {
}
