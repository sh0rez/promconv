...
func NewContainerCpuRequest() ContainerCpuRequest {
	return ContainerCpuRequest{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_cpu_request",
		Help: "CPU resource requested for the container",
	})}
}

func (m ContainerCpuRequest) Register(regs ...prometheus.Registerer) ContainerCpuRequest {
	if regs == nil {
