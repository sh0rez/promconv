...
func NewContainerStorageLimit() ContainerStorageLimit {
	return ContainerStorageLimit{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_storage_limit",
		Help: "Maximum storage resource limit set for the container",
	})}
}

func (m ContainerStorageLimit) Register(regs ...prometheus.Registerer) ContainerStorageLimit {
	if regs == nil {
