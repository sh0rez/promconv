...
func NewContainerEphemeralStorageLimit() ContainerEphemeralStorageLimit {
	return ContainerEphemeralStorageLimit{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_ephemeral_storage_limit",
		Help: "Maximum ephemeral storage resource limit set for the container",
	})}
}

func (m ContainerEphemeralStorageLimit) Register(regs ...prometheus.Registerer) ContainerEphemeralStorageLimit {
	if regs == nil {
...
State {
    ...
    ctx: {
        ...
        "Name": "container.ephemeral_storage.limit",
