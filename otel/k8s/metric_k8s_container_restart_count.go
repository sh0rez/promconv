...
func NewContainerRestartCount() ContainerRestartCount {
	return ContainerRestartCount{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "k8s_container_restart_count",
		Help: "Describes how many times the container has restarted (since the last counter reset)",
	})}
}

func (m ContainerRestartCount) Register(regs ...prometheus.Registerer) ContainerRestartCount {
	if regs == nil {
