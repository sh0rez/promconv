...
func (m DeploymentDesiredPods) With(extra DeploymentDesiredPodsOptional) prometheus.Gauge {
	return m.WithLabelValues()
}

type DeploymentDesiredPodsOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "DeploymentDesiredPodsOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
