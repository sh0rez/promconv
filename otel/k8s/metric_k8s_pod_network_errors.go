...
func NewPodNetworkErrors() PodNetworkErrors {
	...
	return PodNetworkErrors{CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
		Name: "k8s_pod_network_errors",
		Help: "Pod network errors",
	}, labels)}
}

func (m PodNetworkErrors) With(extras ...interface {
...
func (a PodNetworkErrorsExtra) NetworkInterfaceName() network.AttrInterfaceName {
	return a.AttrNetworkInterfaceName
}
func (a PodNetworkErrorsExtra) NetworkIoDirection() network.AttrIoDirection {
