...
func NewThreadPoolThreadCount() ThreadPoolThreadCount {
	return ThreadPoolThreadCount{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "dotnet_thread_pool_thread_count",
		Help: "The number of thread pool threads that currently exist.",
	})}
}

func (m ThreadPoolThreadCount) Register(regs ...prometheus.Registerer) ThreadPoolThreadCount {
	if regs == nil {
