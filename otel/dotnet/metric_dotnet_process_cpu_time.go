...
func (m ProcessCpuTime) With(mode cpu.AttrMode, extra ProcessCpuTimeOptional) prometheus.Counter {
	return m.WithLabelValues(
		string(mode),
	)
}

type ProcessCpuTimeOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ProcessCpuTimeOptional",
        "Instr": "Counter",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
