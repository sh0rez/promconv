...
type EventloopDelayP50 struct {
	prometheus.Gauge
}

func NewEventloopDelayP50() EventloopDelayP50 {
	return EventloopDelayP50{Gauge: prometheus.NewGauge(prometheus.GaugeOpts{
		Name: "nodejs_eventloop_delay_p50",
		Help: "Event loop 50 percentile delay.",
	})}
}

func (m EventloopDelayP50) Register(regs ...prometheus.Registerer) EventloopDelayP50 {
	if regs == nil {
...
State {
    ...
    ctx: {
        ...
        "Name": "eventloop.delay.p50",
        "Type": "EventloopDelayP50",
        "ctx": {
            "attributes": [],
