...
func (m EventloopDelayP99) With(extra EventloopDelayP99Optional) prometheus.Gauge {
	return m.WithLabelValues()
}

type EventloopDelayP99Optional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "EventloopDelayP99Optional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
