...
func (m EventloopDelayMax) With(extra EventloopDelayMaxOptional) prometheus.Gauge {
	return m.WithLabelValues()
}

type EventloopDelayMaxOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "EventloopDelayMaxOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
