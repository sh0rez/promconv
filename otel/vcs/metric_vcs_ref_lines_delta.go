...
func (m RefLinesDelta) With(lineChangeType AttrLineChangeType, refBaseName AttrRefBaseName, refBaseType AttrRefBaseType, refHeadName AttrRefHeadName, refHeadType AttrRefHeadType, repositoryUrlFull AttrRepositoryUrlFull, extra RefLinesDeltaOptional) prometheus.Gauge {
...
type RefLinesDeltaOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "RefLinesDeltaOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
