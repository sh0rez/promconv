...
func NewRefLinesDelta() RefLinesDelta {
	labels := []string{"vcs_line_change_type", "vcs_ref_base_name", "vcs_ref_base_type", "vcs_ref_head_name", "vcs_ref_head_type", "vcs_repository_url_full", "vcs_change_id", "vcs_owner_name", "vcs_repository_name", "vcs_provider_name"}
	return RefLinesDelta{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "vcs",
		Name:      "ref_lines_delta",
		Help:      "The number of lines added/removed in a ref (branch) relative to the ref from the `vcs.ref.base.name` attribute.",
	}, labels)}
}

func (m RefLinesDelta) With(lineChangeType AttrLineChangeType, refBaseName AttrRefBaseName, refBaseType AttrRefBaseType, refHeadName AttrRefHeadName, refHeadType AttrRefHeadType, repositoryUrlFull AttrRepositoryUrlFull, extra interface {
...
func (a RefLinesDeltaExtra) AttrVcsChangeId() AttrChangeId             { return a.VcsChangeId }
func (a RefLinesDeltaExtra) AttrVcsOwnerName() AttrOwnerName           { return a.VcsOwnerName }
func (a RefLinesDeltaExtra) AttrVcsRepositoryName() AttrRepositoryName { return a.VcsRepositoryName }
func (a RefLinesDeltaExtra) AttrVcsProviderName() AttrProviderName     { return a.VcsProviderName }
