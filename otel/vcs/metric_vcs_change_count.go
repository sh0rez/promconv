...
func NewChangeCount() ChangeCount {
	...
	return ChangeCount{GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
...
func (m ChangeCount) With(changeState AttrChangeState, repositoryUrlFull AttrRepositoryUrlFull, extras ...interface {
