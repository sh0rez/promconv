...
func (m RefRevisionsDelta) With(refBaseName AttrRefBaseName, refBaseKind AttrRefBaseType, refHeadName AttrRefHeadName, refHeadKind AttrRefHeadType, repositoryUrlFull AttrRepositoryUrlFull, revisionDeltaDirection AttrRevisionDeltaDirection, extras ...interface {
	VcsChangeId() AttrChangeId
