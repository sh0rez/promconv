...
func (m RefRevisionsDelta) With(refBaseName AttrRefBaseName, refBaseType AttrRefBaseType, refHeadName AttrRefHeadName, refHeadType AttrRefHeadType, repositoryUrlFull AttrRepositoryUrlFull, revisionDeltaDirection AttrRevisionDeltaDirection, extra RefRevisionsDeltaOptional) prometheus.Gauge {
...
type RefRevisionsDeltaOptional struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "RefRevisionsDeltaOptional",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
