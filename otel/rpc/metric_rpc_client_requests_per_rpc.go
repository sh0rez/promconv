...
func (m ClientRequestsPerRpc) With(extra ClientRequestsPerRpcOptional) prometheus.Observer {
	return m.WithLabelValues()
}

type ClientRequestsPerRpcOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientRequestsPerRpcOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
