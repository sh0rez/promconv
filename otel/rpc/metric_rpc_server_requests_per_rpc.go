...
func NewServerRequestsPerRpc() ServerRequestsPerRpc {
	labels := []string{}
	return ServerRequestsPerRpc{HistogramVec: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		Namespace: "rpc",
		Name:      "server_requests_per_rpc",
		Help:      "Measures the number of messages received per RPC.",
	}, labels)}
}

func (m ServerRequestsPerRpc) With(extra ServerRequestsPerRpcOptional) prometheus.Observer {
	return m.WithLabelValues()
}

type ServerRequestsPerRpcOptional struct {
}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ServerRequestsPerRpcOptional",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
